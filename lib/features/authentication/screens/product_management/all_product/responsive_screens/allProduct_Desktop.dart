...
import 'package:absensi/routes/routes.dart'; // Tambahkan import routes
import 'package:absensi/utils/constans/sizes.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:iconsax/iconsax.dart'; // Tambahkan iconsax

class AllProductsDesktopScreen extends StatefulWidget {
  const AllProductsDesktopScreen({super.key});

  @override
  _AllProductsDesktopScreenState createState() => _AllProductsDesktopScreenState();
}

class _AllProductsDesktopScreenState extends State<AllProductsDesktopScreen> {

...
class AllProductsTabletScreen extends StatefulWidget {
  const AllProductsTabletScreen({super.key});

  @override
  _AllProductsTabletScreenState createState() => _AllProductsTabletScreenState();
}

class _AllProductsTabletScreenState extends State<AllProductsTabletScreen> {

...
class BorrowedProductMobileScreen extends StatefulWidget {
  const BorrowedProductMobileScreen({super.key});

  @override
  _BorrowedProductMobileScreenState createState() => _BorrowedProductMobileScreenState();
}

class _BorrowedProductMobileScreenState extends State<BorrowedProductMobileScreen> {

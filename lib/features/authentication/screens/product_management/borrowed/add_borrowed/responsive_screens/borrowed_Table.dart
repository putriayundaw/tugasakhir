...
class BorrowedProductTableScreen extends StatefulWidget {
  const BorrowedProductTableScreen({super.key});

  @override
  _BorrowedProductTableScreenState createState() => _BorrowedProductTableScreenState();
}

class _BorrowedProductTableScreenState extends State<BorrowedProductTableScreen> {

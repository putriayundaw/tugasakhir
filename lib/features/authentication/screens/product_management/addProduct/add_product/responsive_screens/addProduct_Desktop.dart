...
class AddProductsDesktopScreen extends StatefulWidget {
  const AddProductsDesktopScreen({super.key});

  @override
  _AddProductsDesktopScreenState createState() => _AddProductsDesktopScreenState();
}

class _AddProductsDesktopScreenState extends State<AddProductsDesktopScreen> {

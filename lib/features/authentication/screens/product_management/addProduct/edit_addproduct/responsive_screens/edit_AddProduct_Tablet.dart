...
class EditAddProductTabletScreen extends StatelessWidget {
  const EditAddProductTabletScreen({
    super.key,
    required this.product, // Pastikan parameter 'products' diterima dengan benar
  });

  final ProductModel product; // Properti 'products' dideklarasikan sebagai final
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Form
            //  EditAddProductsForm(product: product,),

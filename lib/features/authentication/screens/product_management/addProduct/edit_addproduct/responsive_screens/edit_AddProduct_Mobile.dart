...
class EditAddProductMobileScreen extends StatelessWidget {
  const EditAddProductMobileScreen({    super.key,
    required this.product, // Menggunakan required dan menyesuaikan tipe data
  });

  final ProductModel product; // Properti yang menyimpan data produk

...
class CreateStockDesktopScreen extends StatelessWidget {
  const CreateStockDesktopScreen({super.key});
    ...
    return const Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
        TBreadcrumbsWithHeading(returnToPreviousScreen : true, heading: 'Add New Stock', breadcrumbItems: [TRoutes.createinStock, 'Add New Stock']),

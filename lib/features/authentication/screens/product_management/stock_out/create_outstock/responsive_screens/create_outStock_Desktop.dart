...
class CreateOutStockDesktopScreen extends StatelessWidget {
  const CreateOutStockDesktopScreen({super.key});
    ...
    return const Scaffold(
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
        TBreadcrumbsWithHeading(heading: 'Out stock', breadcrumbItems: [TRoutes.createoutStock, 'Create Out Stock']),

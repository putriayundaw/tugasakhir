...
class EditOutStockMobileScreen extends StatelessWidget {
  const EditOutStockMobileScreen({    super.key,
    required this.products, // Menggunakan required dan menyesuaikan tipe data
  });

  final ProductModel products; // Properti yang menyimpan data produk

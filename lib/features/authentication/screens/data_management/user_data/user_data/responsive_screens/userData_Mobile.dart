...
class UserDataMobileScreen extends StatefulWidget {
  const UserDataMobileScreen({super.key});

   @override
  _UserDataMobileScreenState createState() => _UserDataMobileScreenState();
}

class _UserDataMobileScreenState extends State<UserDataMobileScreen> {

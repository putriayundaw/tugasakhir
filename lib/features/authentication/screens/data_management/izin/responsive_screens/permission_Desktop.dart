...
class PermissionDesktopScreen extends StatelessWidget {
  const PermissionDesktopScreen({super.key});
              ...
              child: Column(
                children: [
                  TAddPermissionTableHeader(
                    ...
                    // onPressed: () {print(izinController.permissions.first.images.toString());},
